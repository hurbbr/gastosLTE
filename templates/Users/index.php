...
<div class="card card-dark card-outline">
  <div class="card-header d-sm-flex">
    ...
    <div class="card-toolbox">
      ...
      <?= $this->Html->link(__('New User'), ['action' => 'addLogin'], ['class' => 'btn btn-primary btn-sm']) ?>
    </div>
  </div>
  <!-- /.card-header -->
        ...
        <?php foreach ($users as $user) : ?>
          <tr>
            ...
            <td class="actions">
              ...
              <?= $this->Html->link(__('Edit'), ['action' => 'edit', $user->id], ['class' => 'btn btn-xs btn-outline-success', 'escape' => false]) ?>
